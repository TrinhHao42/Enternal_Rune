    ...
    return (
        <header className="flex items-center justify-between z-30 px-6 md:px-16 lg:px-24 xl:px-32 py-6 w-full border-b border-gray-200">
            ...
            <div className="hidden md:flex space-x-4">
                <Link
                    className="relative inline-block cursor-pointer px-5 py-2"
                    href={'/CartScreen'}
                >
                    <Cart style={{ color: 'gray', width: '24px', height: '24px' }} />
                    {cartQuantity > 0 && (
                        <span className="absolute top-0 right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-amber-500 rounded-full">
                            {cartQuantity}
                        </span>
                    )}
                </Link>
